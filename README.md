...
Bu repository, JavaScript yeteneklerimi geliştirmek, algoritma mantığımı güçlendirmek ve modern web geliştirme tekniklerini öğrenmek amacıyla oluşturduğum projeleri ve pratikleri içermektedir.

Takip ettiğim eğitim serisi ve dökümantasyonlar doğrultusunda, basitten karmaşığa doğru giden projeleri burada derliyorum.
...
Bu süreçte odaklandığım temel konular:
- **JavaScript Temelleri:** Değişkenler, Veri Tipleri, Fonksiyonlar.
- **DOM Manipülasyonu:** HTML elementlerini seçme, değiştirme ve dinamik içerik üretme.
- **Mantıksal Akış:** `if/else`, döngüler ve algoritmik düşünme.
